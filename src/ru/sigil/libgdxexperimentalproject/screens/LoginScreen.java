...
import ru.sigil.libgdxexperimentalproject.view.LoginRenderer;
...
public class LoginScreen implements Screen, InputProcessor {
    ...
    @Override
    public void show() {
        LoginHUD loginHUD = new LoginHUD(myGame);
        renderer = new LoginRenderer(loginHUD);
        Gdx.input.setInputProcessor(loginHUD.getStage());
    }
