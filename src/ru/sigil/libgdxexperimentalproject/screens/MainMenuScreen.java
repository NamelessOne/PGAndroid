...
import ru.sigil.libgdxexperimentalproject.view.MainMenuRenderer;
...
public class MainMenuScreen implements Screen, InputProcessor {
    ...
    @Override
    public void show() {
        MainMenuHUD mainMenuHUD = new MainMenuHUD(myGame);
        renderer = new MainMenuRenderer(mainMenuHUD);
        Gdx.input.setInputProcessor(mainMenuHUD.getStage());
    }
